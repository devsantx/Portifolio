...
export const resources = {
  en: {
    translation: {
      ...
      cargo2: "CTO of SIZAC",
      cargo3: "Student at Cesar School and UFRPE",
      cargo4: "",
      cargo5: "Surgery Appointment Operator",
      cargo6: "",
      cargo7: "Systems support",
      cargo8: "",
      cargo9: "",
      ...
      description2: "Kauan Alves is a developer focused and objective in his activities, managing to execute tasks within short deadlines with excellence. It stands out mainly for its performance and versatility in different projects. Regardless of the complexity of the demands, he excels with skill, due to his resilience and commitment, which makes him an essential member of any team. Its success is a reflection of a constant process of learning and dedication.",
      description3: "Kauan Alves is a developer with exceptional qualities, highlighting his constant search for new challenges, as well as his determination to keep his projects in technical evolution. He is a great collaborator for projects, due to his excellent communication and competence.",
      description4: "",
      description5: "Kauan is an excellent classmate, always committed to offering support when questions arise. When he comes across something he doesn't know how to answer, he shows initiative when researching and returns the next day with the solution. He communicates efficiently and transmits his knowledge in a clear and objective manner. His main quality is his focus on the goals he seeks, continually dedicating himself to improving his professional skills and personal growth.",
      description6: "",
      description7: "Kauan Alves is a dedicated front-end programmer, with expertise in HTML, CSS, JavaScript and React. It combines refined design and functionality to create attractive and responsive applications. With good communication and teamwork, he stands out for his commitment to code quality and his constant search for learning.",
      description8: "",
      description9: "",
    },
  },
  pt: {
    translation: {
      ...
      cargo2: "CTO do SIZAC",
      cargo3: "Estudante da Cesar School e UFRPE",
      cargo4: "",
      cargo5: "Operadora de Marcação de Cirurgia",
      cargo6: "",
      cargo7: "Suporte de sistemas",
      cargo8: "",
      cargo9: "",
      ...
      description2: "Kauan Alves é um desenvolvedor focado e objetivo em suas atividades, conseguindo executar tarefas em prazos curtos com excelência. Destaca-se principalmente pelo seu desempenho e pela sua versatilidade em diferentes projetos. Independentemente da complexidade das demandas, ele se sobressai com habilidade, devido à sua resiliência e empenho, o que o torna um membro essencial em qualquer equipe. Seu sucesso é reflexo de um constante processo de aprendizado e dedicação.",
      description3: "Kauan Alves é um desenvolvedor com qualidades excepcionais, tendo em destaque sua busca constante por novos desafios, bem como sua determinação em manter seus projetos em evolução técnica. É um ótimo colaborador para projetos, devido sua ótima comunicação e competência.",
      description4: "",
      description5: "Kauan é um excelente colega de turma, sempre comprometido em oferecer suporte diante das dúvidas que surgem. Quando se depara com algo que não sabe responder, demonstra iniciativa ao pesquisar e retorna no dia seguinte com a solução. Possui uma comunicação eficiente e transmite seus conhecimentos de maneira clara e objetiva. Sua principal qualidade é o foco nas metas que almeja, dedicando-se continuamente ao aprimoramento de suas habilidades profissionais e ao crescimento pessoal.",
      description6: "",
      description7: "Kauan Alves é um programador front-end dedicado, com expertise em HTML, CSS, JavaScript e React. Une design apurado e funcionalidade para criar aplicações atraentes e responsivas. Com boa comunicação e trabalho em equipe, destaca-se pelo compromisso com a qualidade do código e pela busca constante por aprendizado.",
      description8: "",
      description9: "",
    },
  },
